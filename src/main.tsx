...
const faqs = [
  ['What is the difference between a Virtual Number and Rent a Line?', 'Virtual Numbers are designed for OTP verification. Rental numbers are dedicated to you for a selected period and can support voice and SMS where available.'],
  ['Which countries and services are supported?', 'Coverage and service availability change with live inventory. Select a country and service inside your account to see what is currently available.'],
  ['How do I fund my wallet?', 'Open Fund after signing in and use the payment method available for your account and region. Your balance updates after payment confirmation.'],
