/**
 * Official Verxor channels.
 * Replace placeholder URLs when real accounts are ready — keep this file as the single source.
 */
export const SOCIAL = {
  telegramSupport: 'https://t.me/VerxorOfficial',
  ...
  facebook: 'https://facebook.com/verxorofficial',
  tiktok: 'https://tiktok.com/@verxorofficial',
} as const;
